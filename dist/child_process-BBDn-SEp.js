...
`;
  ...
  async function installPackages(args, ctx, pm = "npm") {
    const { DependencyInstaller } = await import("./index-B9T69g4d.js").then(async (m) => {
      await m.__tla;
      return m;
    }).then((n) => n.ah);
...
`;
    ...
    try {
      const { RegistryClient } = await import("./index-B9T69g4d.js").then(async (m) => {
        await m.__tla;
        return m;
      }).then((n) => n.ax);
