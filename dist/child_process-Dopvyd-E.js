...
`;
  ...
  async function installPackages(args, ctx, pm = "npm") {
    const { DependencyInstaller } = await import("./index--Qr8LVpQ.js").then(async (m) => {
      await m.__tla;
      return m;
    }).then((n) => n.ad);
...
`;
    ...
    try {
      const { RegistryClient } = await import("./index--Qr8LVpQ.js").then(async (m) => {
        await m.__tla;
        return m;
      }).then((n) => n.as);
