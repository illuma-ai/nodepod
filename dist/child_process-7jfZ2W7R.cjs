...
async function installPackages(args, ctx, pm = "npm") {
  const { DependencyInstaller } = await Promise.resolve().then(() => require('./index-DHo9Y19z.cjs')).then(n => n.installer);
...
`;
  ...
  try {
    const { RegistryClient } = await Promise.resolve().then(() => require('./index-DHo9Y19z.cjs')).then(n => n.registryClient);
...
//# sourceMappingURL=child_process-7jfZ2W7R.cjs.map
